        ...
        <div class="chat-msg chat-msg-bot">
          ...
          <div class="chat-bubble">
            ...
            <div class="chat-bubble-body">
              Greetings, Analyst. I am your real-time <strong>AI Assistant</strong> powered by advanced quantitative models and live market feeds. You can ask me any question regarding your loaded equities, sector rotation, turnaround catalysts, Indian & US market trajectories, or specific stock forecasts.
            </div>
          </div>
        </div>
      `;
    ...
    chatForm.addEventListener('submit', async (e) => {
        ...
        <div class="chat-bubble">
          ...
          <div class="chat-bubble-body">
            <div class="typing-pulse-indicator">
              <span>🧠 AI Neural Engine Analyzing Trajectories</span>
      ...
      try {
        ...
        if (data.success && data.reply) {
          ...
          if (badgePill) {
            badgePill.textContent = data.isFallback ? 'DETERMINISTIC INTEL' : 'AI SYNTHESIS';
            if (data.isFallback && data.debugReason) {
              badgePill.title = `Fallback diagnostic: ${data.debugReason}`;
            } else {
              badgePill.title = 'Synthesized in real-time via AI Neural Engine';
            }
          }
